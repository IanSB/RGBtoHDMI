...
static param_t params[] = {
   ...
   { ALL_OFFSETS,      "Sampling Phase",          "offset", 0,  15, 1, 0 },
//block of hidden RGB options for file compatibility
   {    A_OFFSET,    "A Phase",    "a_offset", 0,   15, 1, 0 },
   {    B_OFFSET,    "B Phase",    "b_offset", 0,   15, 1, 0 },
   {    C_OFFSET,    "C Phase",    "c_offset", 0,   15, 1, 0 },
   {    D_OFFSET,    "D Phase",    "d_offset", 0,   15, 1, 0 },
   {    E_OFFSET,    "E Phase",    "e_offset", 0,   15, 1, 0 },
   {    F_OFFSET,    "F Phase",    "f_offset", 0,   15, 1, 0 },
   {        HALF,        "Half Pixel Shift",        "half", 0,   1, 1, 0 },
   {     DIVIDER,    "Clock Multiplier",    "multiplier", 0,   7, 1, 0 },
   {       RANGE,    "Calibration Range",   "range", 0, NUM_RANGE-1, 1, 0 },
//end of hidden block
   ...
   {        EDGE,  "Sync Edge",         "edge", 0,   1, 1, 0 },
   {   CLAMPTYPE,  "Clamp Type",   "clamptype", 0,     NUM_CLAMPTYPE-1, 1, 0 },
   {         MUX,  "Sync on Y/V",     "input_mux", 0,   1, 1, 0 },
   {        RATE,  "Sample Mode", "sample_mode", 1,   2, 1, 0 },
   {   TERMINATE,  "75R Termination", "termination", 0,   NUM_YUV_TERM-1, 1, 0 },
   {    COUPLING,  "Y Coupling", "coupling", 0,   NUM_YUV_COUPLING-1, 1, 0 },
   {       DAC_A,  "DAC-A: Y Hi",      "dac_a", 0, 256, 1, 0 },
   {       DAC_B,  "DAC-B: Y Lo",      "dac_b", 0, 256, 1, 0 },
   {       DAC_C,  "DAC-C: UV Hi",     "dac_c", 0, 256, 1, 0 },
   {       DAC_D,  "DAC-D: UV Lo",     "dac_d", 0, 256, 1, 0 },
   {       DAC_E,  "DAC-E: Sync",      "dac_e", 0, 256, 1, 0 },
   {       DAC_F,  "DAC-F: Y/V Sync",   "dac_f", 0, 256, 1, 0 },
   {       DAC_G,  "DAC-G: Y Clamp",   "dac_g", 0, 256, 1, 0 },
...
cpld_t cpld_yuv_analog_mono = {
   ...
   .nameRGBprefix = "RGB",
   .nameYUVprefix = "YUV",
   .default_profile = "Commodore/Commodore_64_Lumacode",
   .init = cpld_init_analog,
   .get_version = cpld_get_version,
   .calibrate = cpld_calibrate,
   .set_mode = cpld_set_mode,
