...
static param_t params[] = {
   {  CPLD_SETUP_MODE,  "Setup Mode", "setup_mode", 0,NUM_CPLD_SETUP-1, 1, 0 },
   { ALL_OFFSETS, "Sampling Phase", "all_offsets", 0,   0, 1, 0 },
   {    A_OFFSET,    "A Phase",    "a_offset", 0,   0, 1, 0 },
   {    B_OFFSET,    "B Phase",    "b_offset", 0,   0, 1, 0 },
   {    C_OFFSET,    "C Phase",    "c_offset", 0,   0, 1, 0 },
   {    D_OFFSET,    "D Phase",    "d_offset", 0,   0, 1, 0 },
   {    E_OFFSET,    "E Phase",    "e_offset", 0,   0, 1, 0 },
   {    F_OFFSET,    "F Phase",    "f_offset", 0,   0, 1, 0 },
   {        HALF,    "Half Pixel Shift",        "half", 0,   1, 1, 0 },
   {     DIVIDER,    "Clock Multiplier",    "multiplier", 0,   7, 1, 0 },
   {       RANGE,    "Calibration Range",    "range", 0,   1, 1, 0 },
   {       DELAY,    "Pixel H Offset",       "delay", 0,  15, 1, 0 },
//block of hidden YUV options for file compatibility
   {    FILTER_L,  "Filter Y",      "l_filter", 0,   1, 1, 0 },
   {       SUB_C,  "Subsample UV",     "sub_c", 0,   1, 1, 0 },
   {       ALT_R,  "PAL switch",       "alt_r", 0,   1, 1, 0 },
   {        EDGE,  "Sync Edge",         "edge", 0,   NUM_EDGE-1, 1, 0 },
   {   CLAMPTYPE,  "Clamp Type",   "clamptype", 0,   4, 1, 0 },
//end of hidden block
   {         MUX,  "Sync on G/V",   "input_mux", 0,   1, 1, 0 },
   {        RATE,  "Sample Mode", "sample_mode", 0, NUM_RGB_RATE-1, 1, 0 },
   {   TERMINATE,  "75R Termination", "termination", 0,   NUM_RGB_TERM-1, 1, 0 },
   {    COUPLING,  "G Coupling", "coupling", 0,   NUM_RGB_COUPLING-1, 1, 0 },
   {       DAC_A,  "DAC-A: G Hi",     "dac_a", 0, 256, 1, 0 },
   {       DAC_B,  "DAC-B: G Lo",     "dac_b", 0, 256, 1, 0 },
   {       DAC_C,  "DAC-C: RB Hi",    "dac_c", 0, 256, 1, 0 },
   {       DAC_D,  "DAC-D: RB Lo",    "dac_d", 0, 256, 1, 0 },
   {       DAC_E,  "DAC-E: Sync",     "dac_e", 0, 256, 1, 0 },
   {       DAC_F,  "DAC-F: G/V Sync",  "dac_f", 0, 256, 1, 0 },
   {       DAC_G,  "DAC-G: G Clamp",  "dac_g", 0, 256, 1, 0 },
   {       DAC_H,  "DAC-H: Unused",   "dac_h", 0, 256, 1, 0 },
   {          -1,          NULL,          NULL, 0,   0, 1, 0 }
};
...
cpld_t cpld_rgb_analog = {
   ...
   .nameRGBprefix = "RGB",
   .nameYUVprefix = "YUV",
   .default_profile = "Amstrad_/Amstrad_CPC_",
...
cpld_t cpld_rgb_analog_mono = {
   ...
   .nameRGBprefix = "RGB",
   .nameYUVprefix = "YUV",
   .default_profile = "Commodore/Commodore_64_Lumacode_(Unterm)",
   .init = cpld_init_rgb_analog,
   .get_version = cpld_get_version,
   .calibrate = cpld_calibrate,
   .set_mode = cpld_set_mode,
...
cpld_t cpld_rgb_analog_24mhz = {
   ...
   .nameRGBprefix = "RGB",
   .nameYUVprefix = "YUV",
   .default_profile = "Acorn/BBC_Micro_",
   .init = cpld_init_rgb_analog,
   .get_version = cpld_get_version,
   .calibrate = cpld_calibrate,
   .set_mode = cpld_set_mode,
